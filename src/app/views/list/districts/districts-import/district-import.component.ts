...
@Component({
	selector: 'app-district-import',
	templateUrl: './district-import.component.html',
	styleUrls: ['./district-import.component.scss'],
	encapsulation: ViewEncapsulation.None
})

export class DistrictImportComponent implements OnInit {
	currentUser: any;
	_files: any = null;
	...
	constructor(public activeModal: NgbActiveModal, config: NgbModalConfig, private districtService: DistrictService) {
	...
	ImportDistrict() {
		const _this = this;
		this.districtService.import(this.importViewModel).subscribe((result: any) => {
