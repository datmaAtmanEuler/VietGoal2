...
@Component({
	selector: 'app-age-import',
	templateUrl: './age-import.component.html',
	styleUrls: ['./age-import.component.scss'],
	encapsulation: ViewEncapsulation.None
})

export class AgeImportComponent implements OnInit {
	currentUser: any;
	_files: any = null;
	...
	constructor(public activeModal: NgbActiveModal, config: NgbModalConfig, private ageService: AgeService) {
	...
	ImportProvince() {
		const _this = this;
		this.ageService.import(this.importViewModel).subscribe((result: any) => {
