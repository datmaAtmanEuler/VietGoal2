...
@Component({
	selector: 'app-recruit-import',
	templateUrl: './recruit-import.component.html',
	styleUrls: ['./recruit-import.component.scss'],
	encapsulation: ViewEncapsulation.None
})

export class RecruitImportComponent implements OnInit {
	currentUser: any;
	_files: any = null;
	...
	constructor(public activeModal: NgbActiveModal, config: NgbModalConfig, private recruitService:RecruitService) {
	...
	ImportUserGroup() {
		const _this = this;
		this.recruitService.import(this.importViewModel).subscribe((result: any) => {
