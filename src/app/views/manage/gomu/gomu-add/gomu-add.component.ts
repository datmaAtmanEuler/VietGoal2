...
@Component({
  selector: 'app-gomu-add',
  templateUrl: './gomu-add.component.html',
  styleUrls: ['./gomu-add.component.scss']
})
export class GomuAddComponent implements OnInit {
  GomuAddList: any[] = [];
