...
@Component({
	...
	templateUrl: './student-registration-import.component.html',
	styleUrls: ['./student-registration-import.component.scss'],
	encapsulation: ViewEncapsulation.None
})

export class StudentRegistrationImportComponent implements OnInit {
	currentUser: any;
	_files: any = null;
