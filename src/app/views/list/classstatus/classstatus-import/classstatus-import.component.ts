...
@Component({
	selector: 'app-classstatus-import',
	templateUrl: './classstatus-import.component.html',
	styleUrls: ['./classstatus-import.component.scss'],
	encapsulation: ViewEncapsulation.None
})

export class ClassStatusImportComponent implements OnInit {
	currentUser: any;
	_files: any = null;
	...
	constructor(public activeModal: NgbActiveModal, config: NgbModalConfig, private classStatusService: ClassStatusService) {
	...
	ImportProvince() {
		const _this = this;
		this.classStatusService.import(this.importViewModel).subscribe((result: any) => {
